// Tunisia's 24 governorates, each mapped to its delegations, used to keep
// listings.city / listings.delegation values standardized instead of free
// text (which invites typos and breaks the city/delegation filters).
const Map<String, List<String>> tunisiaLocations = {
  'Tunis': [
  ...
  'Manouba': [
    ...
    'Borj El Amri', 'El Battan', 'Jedaida', 'Tebourba',
  ],
  'Nabeul': [
  ...
  'Jendouba': [
    'Jendouba', 'Jendouba Nord', 'Ain Draham', 'Balta-Bou Aouene', 'Bou Salem',
  ...
  'Siliana': [
    ...
    'Gaafour', 'Kesra', 'Makthar', 'Rouhia', 'Sidi Bou Rouis',
  ],
  'Kairouan': [
    'Kairouan Nord', 'Kairouan Sud', 'Bou Hajla', 'Chebika', 'Echrarda',
    'Hajeb El Ayoun', 'Haffouz', 'Nasrallah', 'Oueslatia', 'Sbikha',
  ],
  'Kasserine': [
  ...
  'Mahdia': [
    'Mahdia', 'Bou Merdes', 'Chebba', 'Chorbane', 'El Jem', 'Hebira',
    'Ksour Essef', 'Melloulèche', 'Ouled Chamekh', 'Sidi Alouane',
  ],
  'Sfax': [
  ...
  'Gabès': [
    'Gabès Médina', 'Gabès Ouest', 'Gabès Sud', 'El Hamma', 'El Metouia',
    'Ghannouch', 'Mareth', 'Matmata', 'Menzel Habib', 'Nouvelle Matmata', 'Oudhref',
  ],
  'Médenine': [
  ...
  'Gafsa': [
    'Gafsa Nord', 'Gafsa Sud', 'Belkhir', 'El Guettar', 'El Ksar', 'Mdhilla',
    'Métlaoui', 'Moularès', 'Redeyef', 'Sened', 'Sidi Aïch',
  ],
